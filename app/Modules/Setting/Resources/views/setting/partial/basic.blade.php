<fieldset class="mb-1">
   ...
   <div class="form-group row">
    ...
    <fieldset class="mb-1">
        <legend class="text-uppercase font-size-sm font-weight-bold">Private Policy</legend>    

    <div class="row">
        <div class="col-md-12">
            <div class="form-group row">
                <div class="input-group">
                    {!! Form::textarea('privacy_policy', $value = null, ['placeholder'=>'Enter Privacy Policy','class'=>'form-control']) !!}
                </div>
            </div>
        </div>
    </div>
    ...
    <fieldset class="mb-1">
        <legend class="text-uppercase font-size-sm font-weight-bold">Support</legend>    

    <div class="row">
        <div class="col-md-12">
            <div class="form-group row">
                <div class="input-group">
                    {!! Form::textarea('support', $value = null, ['placeholder'=>'Enter Support','class'=>'form-control']) !!}
                </div>
            </div>
        </div>
    </div>
